...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2018 at 05:38 AM
...
INSERT INTO `tbl_doctor` (`doctor_id`, `doctor_name`, `doctor_gender`, `doctor_date_of_birth`, `doctor_address`, `doctor_contact_number`, `doctor_professional_fee`, `deleted`) VALUES
('doc_000001', 'Dr. Martinez', 'Male', '1997-05-12', 'Quezon City Manila', '09157744075', 5000, 0);
...
('180404_001', '2018-04-04', 'ptnt_000001', 'usr_0000001', 1, 'invoice', 7500),
('180413_001', '2018-04-13', 'ptnt_000001', 'usr_0000001', 1, 'invoice', 10000),
('180413_002', '2018-04-13', 'ptnt_000003', 'usr_0000001', 1, 'invoice', 10000),
...
INSERT INTO `tbl_item` (`item_id`, `item_name`, `item_qty`, `deleted`) VALUES
('item_000001', 'Syringe', 100, 0),
('item_000002', 'Cotton', 100, 0);
...
('ptnt_000003', 'Bruno S. Mars ', 'Male', '2000-04-12', 'Las Vegas', 1),
('ptnt_000004', 'Rose Mae S. Pusancho ', 'Female', '1998-05-21', 'Murphy Cuabo Q.C', 1),
('ptnt_000005', 'Merly S. Pusancho ', 'Male', '1997-12-05', 'Sta. Mesa Manila', 1),
...
INSERT INTO `tbl_procedure` (`procedure_id`, `procedure_name`, `procedure_cost`, `deleted`) VALUES
('proc_000001', 'CT-Scan', 2500, 0),
('proc_000002', 'Stiches and Burn', 5000, 0),
('proc_000003', 'Somthing', 800, 0),
('proc_000004', 'asdasda', 100, 0);
...
('usr_0000004', 'Hayley Williams', 'Female', '2018-03-19', 'Paramore', '', 'paramore', 'paramore', 'admin', 3),
