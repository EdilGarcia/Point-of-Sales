        ...
        <div class="row">
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              <li> <a href="dashboard.php"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp Dashboard <span class="sr-only">(current)</span> </a>
              </li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="col-sm-12 col-md-12">
              ...
              <div class="panel panel-primary filterable" style="overflow-y:auto; height:450px;">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        $preparedStmt = "SELECT * FROM `tbl_patient` ORDER BY `patient_name`";
