  ...
  <body>
                              ...
                              <table>
                                <tbody>
                                  <tr id="<?php echo $row['patient_id']; ?>" name="<?php echo $row['patient_name']; ?>">
                                    <?php
                                      if($row['invoice_type'] != 'receipt')
                                        echo('<td><button type="button" class="btn btn-sm btn-primary edit_btn">Edit</button></td>');
                                    ?>
                                        ...
                                        echo ('<td>
                                              ...
                                              <td>
                                                <form method="POST" action="./../../controller/transactions.php">
                                                  <input type="hidden" name="path" value="./../views/user/invoicecreation.php"/>
    ...
    <script type="text/javascript">
      ...
      $(document).on("click", "#open_new_transaction", function() {
        var path = "./../views/user/invoicecreation.php";
        $.ajax({
          url: "./../../controller/modal_views.php",
          method: "post",
