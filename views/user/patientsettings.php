                    ...
                    <tbody>
                      ...
                      ?>
                        <tr class="clickable-row">
                          ...
                          <td class="col-md-2"><input type="submit" class="btn btn-info btn-sm patient_update" value="Update" id="<?php echo $row['patient_id']; ?>" name="patient_update" /></td>
                        </tr>
                        <?php
                        }
                        ?>
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <form class="form-horizontal" role="form" method="post" action="./../../controller/transactions.php">
                ...
                <input type="hidden" value="./../views/user/patientsettings.php" name="path" id="path">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $(".patient_update").click(function() {
          ...
          var path = "./../views/user/patientsettings.php";
          $.ajax({
