            ...
            <div class="col-sm-12 col-md-12">
              <div class="mn-dashboard-header">
                ...
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#mn-procedure-panel" data-toggle="tab">Procedure</a></li>
                  <li><a href="#mn-deleted-procedure-panel" data-toggle="tab">Deleted Procedure</a></li>
                </ul>
              </div>
              <div class="tab-content">
                <div class="panel panel-primary filterable tab-pane active" id="mn-procedure-panel">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        $preparedStmt = "SELECT * FROM `tbl_procedure` WHERE `procedure_status`=1 ORDER BY `procedure_name`";
                ...
                <div class="panel panel-primary filterable tab-pane" id="mn-deleted-procedure-panel">
                  <div class="panel-heading" style="height: 50px;">
                      <h3 class="panel-title">Treatments</h3>
                      <div class="pull-right">
                          <button class="btn btn-default btn-md btn-filter"><span class="fa fa-filter"></span> Filter</button>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        require('./../../controller/db_connect.php');
                        $preparedStmt = "SELECT * FROM `tbl_procedure` WHERE `procedure_status`=2 ORDER BY `procedure_name`";
                        $stmt = $connection->prepare($preparedStmt);
                        $stmt->execute();
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
                        {
                        ...
                        <tr class="clickable-row">
                            ...
                            <td>
                              <form method="POST" action="./../../controller/transactions.php">
                                <input type="hidden" name=path value="./../views/admin/treatmentsettings.php"/>
                                <input type="hidden" name=procedure_id value="<?php echo $row['procedure_id']; ?>"/>
                                <input type="submit" class="btn btn-success btn-sm" value="Restore" name="procedure_activate"/>
                              </form>
                            </td>
                        </tr>
